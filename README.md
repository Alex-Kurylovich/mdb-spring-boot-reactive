...
## Replica!!!
Make sure that mongod.cfg(win) /etc/mongod.conf(mac,linux) replication: is configured:
**https://usavps.com/blog/how-to-fix-mongodb-error-code-123-notareplicaset/**
